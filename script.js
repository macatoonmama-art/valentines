    ...
    tires.forEach((tire) => {
      tire.onclick = () => {
        ...
        if (id === "1") {
          ...
          content.innerHTML = `
            <div class="letter-container" style="max-height: 400px; overflow-y: auto; text-align: left; font-family: 'Press Start 2P', cursive; font-size: 0.7rem; line-height: 1.8; padding-right: 10px;">
              <button id="playMuseoBtn" class="pixel-button" style="margin-bottom: 20px; width: 100%; font-size: 0.6rem;">🎵 Play Background Music</button>
              <h2 style="text-align: center; margin-bottom: 20px; font-size: 0.9rem; color: #c71585;">LETTER FROM ME</h2>
              <p>To Lian,</p><br>
              <p>Halo, it’s me again, Adi, Adibo, Adinye, Aditot, basta lahat na, HAHAHAHA. </p>
              <p>Play mo yung background music habang binabasa mo ’to, ah.</p><br>
              <p>Anyway, first of all, I want to say congratulations on surviving your exam. </p>
              <p>YOU DID SO WELL. </p>
              <p>You said that you think you did not, but no, trying for something is already remarkable, even simply showing up.</p><br>
              <p>Today, I want to take some of your time to show my admiration for you. </p>
              <p>It might have taken me a while to ask you this, but I was waiting for you to finish your exams so you could focus fully on your education. </p>
              <p>I hope I’m not too late, hahaha.</p><br>
              <p>The way you care for the people around you, laugh at my jokes, tell your stories about how your day was going, and stay patient with me, even though I sometimes act stupid (hahaha), are some of the things that made me fall for you. </p>
              <p>You taught me to express myself more, and I think that’s one of the best things I’ve done for myself. </p>
              <p>Lastly, you inspire me to become better than I am, and I am truly thankful for that.</p><br>
              <p>I want you to know that you’re not obligated to do anything in return. </p>
              <p>I did this purely out of love and admiration. </p>
              <p>I hope I made you happy with this little gift of mine. </p>
              <p>You deserve the world for your kind soul.</p>
